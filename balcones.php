...
<head>
    ...
    <title>Condominio Balcones del Este</title>
            ...
            <div class="container-fluid">
                <div id="logo" style="margin-left: 175px; margin-top: 100px"><img id="fotologo" src="assets/logo.png" alt="Logo"/></div>
                    <div id="texto" style="margin-top: 200px">
                            Un exitoso proyecto diseñado y construido en Sabanilla de Montes de Oca, cerca de la zona universitaria. Consta de 20 apartamentos de 1 y 2 habitaciones y 
                            fue desarrolado en un lote de 2100m2. Se encuentra rodeado de áreas verdes, parques y zonas protegidas. 
                            Muy iluminado y ventilado. Aprovecha la vista y cercanía a la naturaleza con balcones y grandes ventanales.
                    </div>
                        ...
                        <h1 id="hportada" style="color: white; letter-spacing: 30px; margin-left: 145px;">BALCONES DEL ESTE - año 2008</h1>
                       <div id="fondoslide" style="background-image: url('./assets/fondoslide.jpg'); background-size: cover; position: relative; right:0; left: 0; width: 1920px; height: 240px; border: 2px solid; border-radius: 2px; z-index: 1001; box-shadow: 0 5px 15px 1px rgba(0, 0, 0, 0.6), 0 0 10px 1px rgba(255, 255, 255, 0.5);">
                        ...
                        <div id="slideshow" class="owl-carousel" style="margin-top:20px">
                           ...
                           <a href="assets/Fotos/balcones.jpg" data-lightbox="slide" data-title="Condominio Balcones del Este"><div class="item"><img src="assets/thumbspro/balcones.png" alt="Condominio Balcones del Este"/></div></a>
                           <a href="assets/Fotos/web_Page_22_Image_0001.jpg" data-lightbox="slide" data-title="Condominio Balcones del Este"><div class="item"><img src="assets/thumbspro/web_Page_22_Image_0001.png" alt="Condominio Balcones del Este"/></div></a>
                           <a href="assets/Fotos/web_Page_23_Image_0001.jpg" data-lightbox="slide" data-title="Condominio Balcones del Este"><div class="item"><img src="assets/thumbspro/web_Page_23_Image_0001.png" alt="Condominio Balcones del Este"/></div></a>
                           <a href="assets/Fotos/web_Page_23_Image_0003.jpg" data-lightbox="slide" data-title="Condominio Balcones del Este"><div class="item"><img src="assets/thumbspro/web_Page_23_Image_0003.png" alt="Condominio Balcones del Este"/></div></a>
                        </div>
                         
                       </div>
                        <a href="pinares.php"><h1 id="links">Siguiente</h1></a>
