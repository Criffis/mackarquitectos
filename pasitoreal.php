...
<head>
    ...
    <title>Condominio Pasito Real</title>
            ...
            <div class="container-fluid">
                <div id="logo" style="margin-left: 175px; margin-top: 100px"><img id="fotologo" src="assets/logo.png" alt="Logo"/></div>
                    <div  id="texto" style="margin-top: 180px;">
                            Desarrollado en Sabanilla de Montes de Oca, 6 unidades ubicadas frente a un parque comunitario y enclavado en una rotonda de baja circulación 
                            y limitado acceso. Apartamentos de 185 m2. Contó con la exitosa compra de familias de clase media-alta. Privacidad, diseño, acabados en ubicación estratégica y 
                            seguridad a precios competitivos, hicieron de este proyecto otro condominio económico y estéticamente exitoso. 
                    </div>
                        ...
                        <h1 id="hportada" style="color: white; letter-spacing: 30px; margin-left: 55px;">CONDOMINIO PASITO REAL - año 2006</h1>
                        ...
                        <div id="slideshow" class="owl-carousel" style="margin-top:20px;">
                           ...
                           <a href="assets/Fotos/web_Page_18_Image_0002.jpg" data-lightbox="slide" data-title="Condominio Pasito Real"><div class="item"><img src="assets/thumbspro/web_Page_18_Image_0002.png" alt="Condominio Pasito Real"/></div></a>
                           <a href="assets/Fotos/web_Page_18_Image_0003.jpg" data-lightbox="slide" data-title="Condominio Pasito Real"><div class="item"><img src="assets/thumbspro/web_Page_18_Image_0003.png" alt="Condominio Pasito Real"/></div></a>
                           <a href="assets/Fotos/web_Page_19_Image_0002.jpg" data-lightbox="slide" data-title="Condominio Pasito Real"><div class="item"><img src="assets/thumbspro/web_Page_19_Image_0002.png" alt="Condominio Pasito Real"/></div></a>
                           <a href="assets/Fotos/web_Page_19_Image_0005.jpg" data-lightbox="slide" data-title="Condominio Pasito Real"><div class="item"><img src="assets/thumbspro/web_Page_19_Image_0005.png" alt="Condominio Pasito Real"/></div></a>
         
                        </div>
                         
                       </div>
                       <a href="altavista.php"><h1 id="links">Siguiente</h1></a>
