            ...
            <div class="container-fluid">
                <div id="logo" style="margin-left: 175px; margin-top: 100px"><img id="fotologo" src="assets/logo.png" alt="Logo"/></div>
                    <div id="texto" style="margin-top: 180px">
                           Una casa que por el vecindario y por tener la vista más agradable hacia atrás, se diseñó más orientada hacia la parte posterior que a la frontal. 
                           Con un lenguaje sobrio y clásico, pero con acabados modernos que buscan contrastar madera y aluminio y plástico, gres porcelanato italiano y madera naturales. 
                           Casa de mediano tamaño, pero muy flexible y ágil con dobles alturas, escaleras de caracol y ventanales muy amplios. 
                    </div>
                        ...
                        <h1 id="hportada" style="color: white; letter-spacing: 30px; margin-left: 280px;">CASA MATOS - año 2000</h1>
                        ...
                        <div id="slideshow" class="owl-carousel" style="margin-top:20px;">
                           ...
                           <a href="assets/Fotos/web_Page_03_Image_0002.jpg" data-lightbox="slide" data-title="Casa Matos"><div class="item"><img src="assets/thumbspro/matos1.png" alt="Casa Matos"/></div></a>
                           <a href="assets/Fotos/matos1.jpeg" data-lightbox="slide" data-title="Casa Matos"><div class="item"><img src="assets/thumbspro/matos3.png" alt="Casa Matos"/></div></a>
                           <a href="assets/Fotos/matos3.jpg" data-lightbox="slide" data-title="Casa Matos"><div class="item"><img src="assets/thumbspro/matos4.png" alt="Casa Matos"/></div></a>
                           <!--<a href="assets/portada/02.jpg" data-lightbox="slide"><div class="item"><img src="assets/thumbs/02.jpg" alt="Owl Image"/></div></a>-->
                           <a href="assets/Fotos/web_Page_03_Image_0003.jpg" data-lightbox="slide" data-title="Casa Matos"><div class="item"><img src="assets/thumbspro/matos2.png" alt="Casa Matos"/></div></a>
                        </div>
                         
                       </div>
                        <a href="gregal57.php"><h1 id="links">Siguiente</h1></a>
