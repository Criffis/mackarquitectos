...
<head>
    ...
    <title>Casa El Gregal Lote 56</title>
            ...
            <div class="container-fluid">
                <div id="logo" style="margin-left: 175px; margin-top: 100px"><img id="fotologo" src="assets/logo.png" alt="Logo"/></div>
                    <div id="texto" style="margin-top: 180px">
                            Las características del terreno cuentan con un frente enorme y un fondo no tan espacioso en una sección. 
                            Las obligaciones de retiros frontales y laterales hicieron del diseño de esta casa un difícil proceso para cumplir con el programa de la familia propietaria. 
                            Se hizo el diseño completo con áreas de piscina y terrazas traseras que al final no se hicieron o se dejaron para una etapa posterior.
                    </div>
                        ...
                        <h1 id="hportada" style="color: white; letter-spacing: 30px; margin-left: 215px">GREGAL LOTE 56 - año 2009</h1>
                        ...
                        <div id="slideshow" class="owl-carousel" style="margin-top:20px;">
                           ...
                           <a href="assets/Fotos/gregal56.jpg" data-lightbox="slide" data-title="Casa El Gregal Lote 56"><div class="item"><img src="assets/thumbspro/gregal56.png" alt="Gregal 56"/></div></a>
                           <a href="assets/Fotos/web_Page_09_Image_0001.jpg" data-lightbox="slide" data-title="Casa El Gregal Lote 56"><div class="item"><img src="assets/thumbspro/web_Page_09_Image_0001.png" alt="Gregal 56"/></div></a>
                           <a href="assets/Fotos/web_Page_09_Image_0003.jpg" data-lightbox="slide" data-title="Casa El Gregal Lote 56"><div class="item"><img src="assets/thumbspro/web_Page_09_Image_0003.png" alt="Gregal 56"/></div></a>
                        </div>
                         
                       </div>
                       <a href="azuola.php"><h1 id="links">Siguiente</h1></a>
