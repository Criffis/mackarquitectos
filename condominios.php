               ...
               <div id="logo" style="margin-left: 175px; margin-top: 100px"><img id="fotologo" src="assets/logo.png" alt="Logo"/></div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 id="hportada" style="color: white; letter-spacing: 50px; font-size: 24px; margin-left: 380px;">CONDOMINIOS</h1>
                        ...
                        <div id="slideshow" class="owl-carousel" style="margin-top:20px">
                           ...
                           <a href="pasitoreal.php"><div class="item"><img src="assets/thumbspro/web_Page_19_Image_0002.png" alt="Pasito Real"/></div><div class="caption">Pasito Real</div></a>
                           <a href="altavista.php"><div class="item"><img src="assets/thumbspro/web_Page_20_Image_0003.png" alt="Altavista"/></div><div class="caption">Altavista</div></a>
                           <a href="balcones.php"><div class="item"><img src="assets/thumbspro/web_Page_22_Image_0001.png" alt="Balcones del Este"/></div><div class="caption">Balcones del Este</div></a>
                           <a href="pinares.php"><div class="item"><img src="assets/thumbspro/pinares.png" alt="Vista Pinares"/></div><div class="caption">Vista Pinares</div></a>
                           <a href="carolina.php"><div class="item"><img src="assets/thumbspro/carolina.png" alt="La Carolina"/></div><div class="caption">La Carolina</div></a>
                        </div>
