     ...
     <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div id="logo" style="margin-left: 175px; margin-top: 320px"><img id="fotologo" src="assets/logo.png" alt="Logo"/></div>
                    <div id="mision">
                            "Poder conjugar las habilidades adquiridas en
                            arquitectura y administración para efectuar obras
                            inteligentes, innovadoras y funcionales con los
                            objetivos financieros del cliente; todo bajo las
                            normas de respeto y de la ética profesional..."
                    </div>
